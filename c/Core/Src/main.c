...
const osThreadAttr_t uartWriter_attributes = {
  .name = "uartWriter",
  .stack_size = 128 * 4,
...
const osThreadAttr_t buttonWaiter_attributes = {
  .name = "buttonWaiter",
  .stack_size = 128 * 4,
...
const osEventFlagsAttr_t buttonInterruptEvent_attributes = {
  .name = "buttonInterruptEvent"
};
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  uartQueueHandle = osMessageQueueNew (8, sizeof(UartMessage), &uartQueue_attributes);
  ...
  uartWriterHandle = osThreadNew(StartUartWriter, NULL, &uartWriter_attributes);

  /* creation of buttonWaiter */
  buttonWaiterHandle = osThreadNew(StartButtonWaiterTask, NULL, &buttonWaiter_attributes);
  ...
  buttonInterruptEventHandle = osEventFlagsNew(&buttonInterruptEvent_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, ButtonInterrupt_Pin|ButtonProcessed_Pin, GPIO_PIN_RESET);
